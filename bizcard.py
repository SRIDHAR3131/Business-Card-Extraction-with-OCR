...
with text_process:
    if selected == 'Home':
        ...
        with right:
            url = requests.get(
                "https://assets5.lottiefiles.com/private_files/lf30_euijmy98.json")
            url_json = dict()
            ...
            with left:
                ...
                st.markdown('###### Bizcard is a Python application designed to extract information from business cards. It utilizes various technologies such as :blue[Streamlit, EasyOCR, regex function, OpenCV, and MySQL] database to achieve this functionality.')
...
#===================text extraction bounding image============================
                if st.button('TEXT BOUNDING'):
                    ...
                    st.info('Some of the image might be inaccurate detection of text will be developed soon...', icon='ℹ️')
    ...
    if selected=='Database':
                ...
                if st.button('Show Image'):
                    ...
                    with right:
                        ...
                        if result:
                            ...
                            print("Image not found for the given name and designation.")
        #update data in database for selected name and designation
            ...
            with name:
                ...
                # Display the selection box
                selection_name = st.selectbox("Select a name to update", row_name)
                selection_designation = st.selectbox("Select a designation to update", row_designation)
            with new_name:
                ...
                selection = st.selectbox("Select a specific column to update", column_names)
