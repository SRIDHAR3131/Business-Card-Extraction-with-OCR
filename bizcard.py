    ...
    if selected == 'Home':
        ...
        with right:
            ...
            with left:
                ...
                st.markdown('###### Bizcard is a Python application designed to extract information from business cards. It utilizes various technologies such as :blue[Streamlit, Python, EasyOCR , RegEx function, OpenCV, and MySQL] database to achieve this functionality.')
